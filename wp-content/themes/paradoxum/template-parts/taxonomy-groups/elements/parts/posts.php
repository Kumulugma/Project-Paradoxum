            ...
            <div class="news-item-3">
                ...
                <div class="news-details">
                    <a href="<?= get_permalink(get_the_ID()) ?>">
                        ...
                        <i><?= get_post_meta(get_the_ID(), "species_name", true) ?></i>
                    </a>
