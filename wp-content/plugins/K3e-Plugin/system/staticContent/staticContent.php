...
//            add_action('admin_menu', 'k3e_admin_menu');
//
//            function k3e_admin_menu() {
//                if(K3eStaticContent::getStaticFormType() == 1) {
//                global $menu;
//                global $submenu;
//                $submenu[K3eStaticContent::getStaticFormPage()] = $submenu['static_content'];
//                $menu[array_key_last($menu)][2] = K3eStaticContent::getStaticFormPage();
//                }
//            }
    ...
    public static function save() {
        ...
        if (isset($_POST['StaticForm'])) {
            ...
            K3eSystem::setSettings('k3e_static_form_type', ($staticForm));
            $save = TRUE;
        }

        if (isset($_POST['StaticFormId'])) {
            $staticFormId = ($_POST['StaticFormId']);
            K3eSystem::setSettings('k3e_static_form_ID', ($staticFormId));
            $save = TRUE;
        }

        if (isset($_POST['StaticFormsAmount'])) {
            $staticFormsAmount = ($_POST['StaticFormsAmount']);
            K3eSystem::setSettings('k3e_static_forms_amount', ($staticFormsAmount));
            $save = TRUE;
        }
        ...
        if (isset($_POST['StaticForms'])) {
            ...
            K3eSystem::setSettings('k3e_static_forms', serialize($staticForms));
            $save = TRUE;
        }
        ...
        if (isset($_POST['StaticContent'])) {
            ...
            K3eSystem::setSettings('k3e_static_content', serialize($StaticContent));
            $save = TRUE;
        }
    ...
    public static function getStaticFormID() {
        $static_form_ID = (get_option('k3e_static_form_ID'));
        if (!$static_form_ID) {
            K3eSystem::setSettings('k3e_static_form_ID', 0, true);
            $static_form_ID = 0;
        }
    ...
    public static function getStaticFormType() {
        $static_form_type = (get_option('k3e_static_form_type'));
        if (!$static_form_type) {
            K3eSystem::setSettings('k3e_static_form_type', 0, true);
            $static_form_type = "";
        }
    ...
    public static function getStaticFormPage() {
        $static_form_link = (get_option('k3e_static_form_ID'));
        if ($static_form_link) {
    ...
    public static function getStaticFormsAmount() {
        $static_forms_amount = (get_option('k3e_static_forms_amount'));
        if (!$static_forms_amount) {
            K3eSystem::setSettings('k3e_static_forms_amount', 0, true);
            $static_forms_amount = "";
        }
    ...
    public static function getStaticForms() {
        $static_forms = unserialize(get_option('k3e_static_forms'));
        if (!$static_forms) {
            K3eSystem::setSettings('k3e_static_forms', serialize([]), true);
            $static_forms = "";
        }
        return $static_forms;
    }
    ...
    public static function getStaticContent() {
        $static_content = unserialize(get_option('k3e_static_content'));
        if (!$static_content) {
            K3eSystem::setSettings('k3e_static_content', serialize([]), true);
            $static_content = [];
        }
