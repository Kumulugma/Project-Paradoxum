<div class="wrap" id="configuration-page">
    <h1 class="wp-heading-inline">
        <?php esc_html_e('Lista nasion', 'k3e'); ?>
    </h1>
                    ...
                    <table id="growlist" class="display" style="width:100%" data-counter="<?= $species->found_posts ?>">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: left;"><?= __('Ilość nasion', 'k3e') ?></th>
                            ...
                            <?php if ($species->have_posts()) { ?>
                                ...
                                <?php while ($species->have_posts()) : $species->the_post(); ?>
                                    <tr>
                                        ...
                                        <td><?= get_post_meta(get_the_ID(), 'species_seeds_amount', true) ?></td>
                                        <td><?= get_post_meta(get_the_ID(), 'species_seeds_price', true) ?></td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endwhile; ?>
                            <?php } else { ?>
