<div id="K3e-Pdf" class="postbox-container" style="width:100%;">
            ...
            <form method="post" action="edit.php?post_type=species&page=growlist_utilities&save=form">
                ...
                <div class="section">
                    <div class="box">
                        ...
                        <div class="input">
                            <label for="k3e_document_pdf_name"><?= __('Komentarz', 'k3e') ?></label>
                            <input id="k3e_package_comment" type="text" name="Growlist[document_comment]" placeholder="<?= __('Komentarz', 'k3e') ?>">
                        </div>
                        <div class="select">
                        ...
                        <div class="save">
                            <?php
                            wp_nonce_field("k3e-growlist-utilities-pdf", 'nonce');
                            ?>
